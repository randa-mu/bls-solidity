...
contract BLS2Test is Common, Test {
    ...
    function table_verify_uncompressed(TestCase memory tc) public view {
        BLS2.PointG2 memory pk = BLS2.g2Unmarshal(parseHex(tc.pk));
        BLS2.PointG1 memory sig = BLS2.g1Unmarshal(parseHex(tc.sig));
    ...
    function table_verify_compressed(TestCase memory tc) public view {
        BLS2.PointG2 memory pk = BLS2.g2Unmarshal(parseHex(tc.pk));
        BLS2.PointG1 memory sig = BLS2.g1UnmarshalCompressed(parseHex(tc.sig_compressed));
